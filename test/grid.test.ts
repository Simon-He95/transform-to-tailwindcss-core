...
describe('grid', () => {
  ...
  it('grid-column: span 1 / span 1;', () => {
    expect(toTailwindcss('grid-column: span 2 / span 2;')).toBe('col-span-2')
  })
  ...
  it('grid-template-rows: none;', () => {
    expect(toTailwindcss('grid-template-rows: none;')).toBe('grid-rows-none')
  })
  ...
  it('grid-auto-rows: min-content;', () => {
    expect(toTailwindcss('grid-auto-rows: min-content;')).toBe('auto-rows-min')
  })
